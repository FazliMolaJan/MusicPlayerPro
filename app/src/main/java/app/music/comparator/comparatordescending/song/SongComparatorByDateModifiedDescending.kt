...
class SongComparatorByDateModifiedDescending : Comparator<BaseMusik> {
    ...
    override fun compare(song1: BaseMusik, song2: BaseMusik): Int {
        ...
        return 0.compareTo(Integer.valueOf(song1.dateModified)
                .compareTo(Integer.valueOf(song2.dateModified)))
    }
}
